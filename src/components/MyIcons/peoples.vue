<template>
  ...
  <svg :width="props.width" :height="props.height" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
        ...
        :fill="props.fill_color" :stroke="props.stroke" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M32.6077 7C34.6405 8.2249 36.0001 10.4537 36.0001 13C36.0001 15.5463 34.6405 17.7751 32.6077 19"
